...
export const DownArrowIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 14l7 7m0 0l7-7m-7 7V3" />
    </svg>
);

export const TargetIcon: React.FC<{ className?: string }> = ({ className = "w-8 h-8 text-brand-cyan" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const ChartBarIcon: React.FC<{ className?: string }> = ({ className = "w-8 h-8 text-brand-cyan" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
    </svg>
);

export const TrendingUpIcon: React.FC<{ className?: string }> = ({ className = "w-8 h-8 text-brand-cyan" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
    </svg>
);
...
export const SystemConfigIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 96 80" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M28 4C21.3726 4 16 9.37258 16 16V24C16 30.6274 21.3726 36 28 36H68C74.6274 36 80 30.6274 80 24V16C80 9.37258 74.6274 4 68 4H28Z" fill="#CCD6F6"/>
      <path d="M28 44C21.3726 44 16 49.3726 16 56V64C16 70.6274 21.3726 76 28 76H68C74.6274 76 80 70.6274 80 64V56C80 49.3726 74.6274 44 68 44H28Z" fill="#CCD6F6"/>
      <circle cx="68" cy="20" r="4" fill="#0A192F"/>
      <circle cx="68" cy="60" r="4" fill="#0A192F"/>
    </svg>
);
...
export const ShieldCheckIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.944a11.955 11.955 0 0118 0 12.02 12.02 0 00-3.382-11.984z" />
    </svg>
);
...
export const WrenchScrewdriverIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 15.75v-3.75m0 0a3.75 3.75 0 00-3.75-3.75H6.75A3.75 3.75 0 003 12m9-3.75a3.75 3.75 0 013.75-3.75h.75A3.75 3.75 0 0121 8.25v3.75m-9-3.75h-3.75" />
    </svg>
);
...
export const CurrencyDollarIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v.01M12 14v1m0-1c-1.11 0-2.08-.402-2.599-1M12 14c.69 0 1.343-.243 1.874-.665m-2.248-5.698a5.982 5.982 0 014.248 0M12 21a9 9 0 100-18 9 9 0 000 18z" />
    </svg>
);
...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m1-9l2.293 2.293a1 1 0 01-1.414 1.414L10 16m-2-2l-2.293-2.293a1 1 0 011.414-1.414L10 12m10 4l2.293 2.293a1 1 0 01-1.414 1.414L18 20m-2-2l-2.293-2.293a1 1 0 011.414-1.414L18 16" />
    </svg>
);

export const RefreshIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h5M20 20v-5h-5M4 4a14.95 14.95 0 0114.65 12.03M20 20a14.95 14.95 0 01-14.65-12.03" />
    </svg>
);
...
export const ShieldExclamationIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m0-10.036A11.956 11.956 0 0121 12c0 3.182-.996 6.13-2.672 8.525A11.952 11.952 0 0112 21.75c-2.673 0-5.216-.584-7.499-1.632A11.952 11.952 0 013 12c0-1.518.295-2.956.834-4.267m10.334 0c-.396-.133-.81-.247-1.233-.332M12 5.25a.75.75 0 00-.75.75v.01c0 .414.336.75.75.75h.01a.75.75 0 00.75-.75v-.01A.75.75 0 0012 5.25z" />
    </svg>
);