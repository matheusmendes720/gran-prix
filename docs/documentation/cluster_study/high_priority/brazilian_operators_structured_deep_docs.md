# 📊 Deep Technical Documentation: Brazilian Telecom Operators Market Data
...
**Name:** Brazilian Telecom Operators Market Data
**Description:** Monthly operator market data from 2019-2024: Vivo, Claro, TIM, Others. Subscribers, market share, 5G coverage.
...
Generated structured data from public reports. Market share dynamics: Vivo (32%), Claro (27%), TIM (20%). Essential for competitive analysis.
...
```bash
# Download dataset
python backend/scripts/fetch_all_ml_datasets.py --dataset brazilian_operators_structured

# Structure for ML
python backend/scripts/structure_ml_datasets.py --dataset brazilian_operators_structured

# Enrich with external factors
python backend/scripts/comprehensive_dataset_pipeline.py --dataset brazilian_operators_structured
```
