# 📊 Deep Technical Documentation: Test Sample Dataset
...
**Description:** Sample dataset for testing pipeline (730 days, 2 years)
...
Test dataset with 2 years of daily data
...
```bash
# Download dataset
python backend/scripts/fetch_all_ml_datasets.py --dataset test_dataset

# Structure for ML
python backend/scripts/structure_ml_datasets.py --dataset test_dataset

# Enrich with external factors
python backend/scripts/comprehensive_dataset_pipeline.py --dataset test_dataset
```
