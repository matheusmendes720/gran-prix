# 📊 Deep Technical Documentation: Brazilian Fiber Optic Expansion Structured Data
...
**Name:** Brazilian Fiber Optic Expansion Structured Data
**Description:** Quarterly fiber household penetration data from 2020-2024 by region (Southeast, South, Northeast, North, Central West).
...
Generated structured data from market reports. Household penetration 25% (2020) to 49% (2024). Regional breakdown essential for infrastructure planning.
...
```bash
# Download dataset
python backend/scripts/fetch_all_ml_datasets.py --dataset brazilian_fiber_structured

# Structure for ML
python backend/scripts/structure_ml_datasets.py --dataset brazilian_fiber_structured

# Enrich with external factors
python backend/scripts/comprehensive_dataset_pipeline.py --dataset brazilian_fiber_structured
```
