# 📊 Deep Technical Documentation: Brazilian Demand Factors (Economic, Climatic, Regulatory)
...
**Name:** Brazilian Demand Factors (Economic, Climatic, Regulatory)
**Description:** Daily demand factors from 2019-2024: GDP growth, inflation, exchange rates, temperature, precipitation, flood risks, 5G milestones, holidays.
...
Generated structured data simulating economic, climatic, and regulatory factors. Essential external factors for demand forecasting models.
...
```bash
# Download dataset
python backend/scripts/fetch_all_ml_datasets.py --dataset brazilian_demand_factors

# Structure for ML
python backend/scripts/structure_ml_datasets.py --dataset brazilian_demand_factors

# Enrich with external factors
python backend/scripts/comprehensive_dataset_pipeline.py --dataset brazilian_demand_factors
```
