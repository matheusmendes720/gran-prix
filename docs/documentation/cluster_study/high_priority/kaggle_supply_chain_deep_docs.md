# 📊 Deep Technical Documentation: High-Dimensional Supply Chain Inventory
...
**Name:** High-Dimensional Supply Chain Inventory
**Description:** Hundreds of thousands of supply chain records
...
Includes external factors, multi-location operations
...
```bash
# Download dataset
python backend/scripts/fetch_all_ml_datasets.py --dataset kaggle_supply_chain

# Structure for ML
python backend/scripts/structure_ml_datasets.py --dataset kaggle_supply_chain

# Enrich with external factors
python backend/scripts/comprehensive_dataset_pipeline.py --dataset kaggle_supply_chain
```
