...
## 5G3E Virtualized Infrastructure Dataset
...
**Purpose:** 14 days of time-series from virtualized 5G infrastructure with radio, server, OS, and network function data. Thousands of features grouped by resource/node type.  
**Records:** 1000 rows  
**Features:** 767 columns  
**Date Range:** Unknown  
**Target Variable:** `quantity` - Target variable for demand forecasting

**Business Context - Deep Analysis:**

14 days of time-series from virtualized 5G infrastructure with radio, server, OS, and network function data. Thousands of features grouped by resource/node type.

### Dataset Origin & Historical Context

**Origin:** GitHub open-source repository
...
|--------|------|-------|-------------|------------------|
| `timestamp;"go_gc_duration_seconds{quantile=""0""}";"go_gc_duration_seconds{quantile=""0.25""}";"go_gc_duration_seconds{quantile=""0.5""}";"go_gc_duration_seconds{quantile=""0.75""}";"go_gc_duration_seconds{quantile=""1""}";go_gc_duration_seconds_sum;go_gc_duration_seconds_count;go_goroutines;"go_info{version=""go1.15.8""}";go_memstats_alloc_bytes;go_memstats_alloc_bytes_total;go_memstats_buck_hash_sys_bytes;go_memstats_frees_total;go_memstats_gc_cpu_fraction;go_memstats_gc_sys_bytes;go_memstats_heap_alloc_bytes;go_memstats_heap_idle_bytes;go_memstats_heap_inuse_bytes;go_memstats_heap_objects;go_memstats_heap_released_bytes;go_memstats_heap_sys_bytes;go_memstats_last_gc_time_seconds;go_memstats_lookups_total;go_memstats_mallocs_total;go_memstats_mcache_inuse_bytes;go_memstats_mcache_sys_bytes;go_memstats_mspan_inuse_bytes;go_memstats_mspan_sys_bytes;go_memstats_next_gc_bytes;go_memstats_other_sys_bytes;go_memstats_stack_inuse_bytes;go_memstats_stack_sys_bytes;go_memstats_sys_bytes;go_threads;"node_arp_entries{device=""eno1""}";"node_arp_entries{device=""eno2""}";"node_arp_entries{device=""eno3""}";"node_arp_entries{device=""eno4""}";node_boot_time_seconds;node_context_switches_total;"node_cooling_device_cur_state{name=""0""` | String | - | timestamp;"go_gc_duration_seconds{quantile=""0""}";"go_gc_duration_seconds{quantile=""0.25""}";"go_gc_duration_seconds{quantile=""0.5""}";"go_gc_duration_seconds{quantile=""0.75""}";"go_gc_duration_seconds{quantile=""1""}";go_gc_duration_seconds_sum;go_gc_duration_seconds_count;go_goroutines;"go_info{version=""go1.15.8""}";go_memstats_alloc_bytes;go_memstats_alloc_bytes_total;go_memstats_buck_hash_sys_bytes;go_memstats_frees_total;go_memstats_gc_cpu_fraction;go_memstats_gc_sys_bytes;go_memstats_heap_alloc_bytes;go_memstats_heap_idle_bytes;go_memstats_heap_inuse_bytes;go_memstats_heap_objects;go_memstats_heap_released_bytes;go_memstats_heap_sys_bytes;go_memstats_last_gc_time_seconds;go_memstats_lookups_total;go_memstats_mallocs_total;go_memstats_mcache_inuse_bytes;go_memstats_mcache_sys_bytes;go_memstats_mspan_inuse_bytes;go_memstats_mspan_sys_bytes;go_memstats_next_gc_bytes;go_memstats_other_sys_bytes;go_memstats_stack_inuse_bytes;go_memstats_stack_sys_bytes;go_memstats_sys_bytes;go_threads;"node_arp_entries{device=""eno1""}";"node_arp_entries{device=""eno2""}";"node_arp_entries{device=""eno3""}";"node_arp_entries{device=""eno4""}";node_boot_time_seconds;node_context_switches_total;"node_cooling_device_cur_state{name=""0"" column | Data field |
| `type=""Processor""}";"node_cooling_device_cur_state{name=""1""` | String | - | type=""Processor""}";"node_cooling_device_cur_state{name=""1"" column | Data field |
| `type=""Processor""}";"node_cooling_device_cur_state{name=""10""` | String | - | type=""Processor""}";"node_cooling_device_cur_state{name=""10"" column | Data field |
| `type=""Processor""}";"node_cooling_device_cur_state{name=""11""` | String | - | type=""Processor""}";"node_cooling_device_cur_state{name=""11"" column | Data field |
| `type=""Processor""}";"node_cooling_device_cur_state{name=""12""` | String | - | type=""Processor""}";"node_cooling_device_cur_state{name=""12"" column | Data field |
| `type=""Processor""}";"node_cooling_device_cur_state{name=""13""` | String | - | type=""Processor""}";"node_cooling_device_cur_state{name=""13"" column | Data field |
| `type=""Processor""}";"node_cooling_device_cur_state{name=""14""` | String | - | type=""Processor""}";"node_cooling_device_cur_state{name=""14"" column | Data field |
| `type=""Processor""}";"node_cooling_device_cur_state{name=""15""` | String | - | type=""Processor""}";"node_cooling_device_cur_state{name=""15"" column | Data field |
| `type=""Processor""}";"node_cooling_device_cur_state{name=""16""` | String | - | type=""Processor""}";"node_cooling_device_cur_state{name=""16"" column | Data field |
| `type=""Processor""}";"node_cooling_device_cur_state{name=""17""` | String | - | type=""Processor""}";"node_cooling_device_cur_state{name=""17"" column | Data field |
| `type=""Processor""}";"node_cooling_device_cur_state{name=""18""` | String | - | type=""Processor""}";"node_cooling_device_cur_state{name=""18"" column | Data field |
| `type=""Processor""}";"node_cooling_device_cur_state{name=""19""` | String | - | type=""Processor""}";"node_cooling_device_cur_state{name=""19"" column | Data field |
| `type=""Processor""}";"node_cooling_device_cur_state{name=""2""` | String | - | type=""Processor""}";"node_cooling_device_cur_state{name=""2"" column | Data field |
| `type=""Processor""}";"node_cooling_device_cur_state{name=""20""` | String | - | type=""Processor""}";"node_cooling_device_cur_state{name=""20"" column | Data field |
| `type=""Processor""}";"node_cooling_device_cur_state{name=""21""` | String | - | type=""Processor""}";"node_cooling_device_cur_state{name=""21"" column | Data field |
| `type=""Processor""}";"node_cooling_device_cur_state{name=""22""` | String | - | type=""Processor""}";"node_cooling_device_cur_state{name=""22"" column | Data field |
| `type=""Processor""}";"node_cooling_device_cur_state{name=""23""` | String | - | type=""Processor""}";"node_cooling_device_cur_state{name=""23"" column | Data field |
| `type=""Processor""}";"node_cooling_device_cur_state{name=""24""` | String | - | type=""Processor""}";"node_cooling_device_cur_state{name=""24"" column | Data field |
| `type=""Processor""}";"node_cooling_device_cur_state{name=""25""` | String | - | type=""Processor""}";"node_cooling_device_cur_state{name=""25"" column | Data field |
| `type=""Processor""}";"node_cooling_device_cur_state{name=""26""` | String | - | type=""Processor""}";"node_cooling_device_cur_state{name=""26"" column | Data field |
| ... | ... | ... | (747 more columns) | ... |
...
```python
# Github 5G3E → Nova Corrente Demand Forecasting

def github_5g3e_to_demand(data):
    """
    Maps github_5g3e data to Nova Corrente demand forecasting format
...
**Context:** Original Github dataset analysis for telecom logistics  
...
**Use Case:** Github 5G3E → Nova Corrente demand forecasting for telecom equipment logistics  
...
- `data/raw/github_5g3e/*.csv` (CSV format)
- `data/raw/github_5g3e/*.csv` (CSV format)
- `data/raw/github_5g3e/*.csv` (CSV format)

**Processed Data:**

- `data/processed/ml_ready/github_5g3e_structured.csv`
...
**Original Notes:** Excellent for predictive maintenance in telecom logistics. Forecasts demand for replacement parts amid long-tail failures (rare node outages). Integrates well with SARIMAX/Prophet/LSTM ensembles for uncertainty hedging. Size may require sampling or batch processing.
...
**Key Insight:** Github 5G3E provides valuable insights for Nova Corrente demand forecasting in Brazilian telecom logistics market
...
- **Feature Count:** 767 features (High-dimensional)
...
**Github 5G3E + Other Datasets:**

**Recommended Integrations:**
1. **With Demand Datasets:**
   - Enrich demand data with github features
...
```python
# Example: Integrate github_5g3e with demand forecasting
import pandas as pd

# Load datasets
demand_df = pd.read_csv('data/processed/ml_ready/demand_structured.csv')
github_5g3e_df = pd.read_csv('data/processed/ml_ready/github_5g3e_structured.csv')
...
merged_df = demand_df.merge(
    ...
    on='date',
    how='left',
    suffixes=('_demand', '_github')
)

# Feature engineering with integrated data
merged_df['github_adjusted_demand'] = (
    merged_df['quantity'] * 
    merged_df['github_multiplier'].fillna(1.0)
)
